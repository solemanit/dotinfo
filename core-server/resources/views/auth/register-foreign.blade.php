        ...
        <div class="p-8 bg-white shadow-2xl rounded-2xl">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div>
                    <div class="relative mt-1 group">
                        ...
                        <input type="text" name="name" placeholder="Full Name" value="{{ old('name') }}"
                            class="w-full py-3 pl-10 pr-4 transition-all duration-200 bg-gray-100 border @error('name') border-red-500 @else border-gray-300 @enderror rounded-full outline-none focus:bg-white focus:border-gray-600 focus:ring-2 focus:ring-gray-600">
                    </div>
                    @error('name')
                ...
                <div>
                    <div class="relative mt-1 group">
                        <i
                            class="absolute text-gray-900 transition -translate-y-1/2 fa fa-envelope left-3 top-1/2 group-focus-within:text-gray-600"></i>
                        <input type="email" name="email" placeholder="Email" value="{{ old('email') }}"
                            class="w-full py-3 pl-10 pr-4 transition-all duration-200 bg-gray-100 border @error('email') border-red-500 @else border-gray-300 @enderror rounded-full outline-none focus:bg-white focus:border-gray-600 focus:ring-2 focus:ring-gray-600">
                    </div>
                    @error('email')
                        <span class="text-sm text-red-600">{{ $message }}</span>
                    @enderror
                ...
                <div>
                    <div class="relative mt-1 group">
                        ...
                        <input type="password" name="password" id="regPassword" placeholder="Password"
                            class="w-full py-3 pl-10 pr-10 transition-all duration-200 bg-gray-100 border @error('password') border-red-500 @else border-gray-300 @enderror rounded-full outline-none focus:bg-white focus:border-gray-600 focus:ring-2 focus:ring-gray-600">
                ...
                <div>
                    <div class="relative mt-1 group">
                        ...
                        <input type="password" name="password_confirmation" placeholder="Confirm Password"
                            class="w-full py-3 pl-10 pr-4 transition-all duration-200 bg-gray-100 border border-gray-300 rounded-full outline-none focus:bg-white focus:border-gray-600 focus:ring-2 focus:ring-gray-600">
                    </div>
                </div>
                ...
                <button type="submit"
                    class="flex items-center justify-center gap-2 py-3 mx-auto text-white transition-all duration-200 bg-gray-900 rounded-full cursor-pointer w-50 hover:bg-gray-800 focus:ring-2 focus:ring-gray-600 focus:outline-none"><svg
                        style="width: 18px;" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                        <path
