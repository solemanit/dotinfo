...
const setNavActive = () => {
    let currentPath = window.location.pathname.split("https://demo.topylo.com/")[0];
    currentPath = location.pathname === "/" ? "index.html" : location.pathname.substring(1);
    currentPath = currentPath.substring(currentPath.lastIndexOf("https://demo.topylo.com/") + 1);
    let sidemenuItems = document.querySelectorAll(".sidebar-menu-item");

    sidemenuItems.forEach((e) => {
        if (currentPath === "https://demo.topylo.com/") {
